      ...
      <main id="main-content">
        ...
        <section className="py-16 bg-teal">
          <div className="max-w-300 mx-auto px-8 max-md:px-5 text-center text-white">
            <h2 className="font-serif text-[2rem] mb-3">Knowledge Is the First Step to Clear Skin</h2>
            <p className="opacity-80 max-w-112.5 mx-auto mb-8 text-[.95rem] leading-[1.7]">
              Ready to put the science into practice? Book a free consultation and let Marta design a plan for your skin.
            </p>
            <a
              href="/contact"
