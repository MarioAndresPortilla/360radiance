...
const jsonLd = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Acne Treatment Program' } },
      ...
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'LED Facial Therapy' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Chemical Peels' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Microneedling Collagen Induction Therapy' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Tattoo Removal Laser' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Oxygen Facial Therapy' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Carbon Yag Laser' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Sulwhasoo Organic Korean Facial' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Skin Deep Facial' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Glass Ampule Serums' } },
