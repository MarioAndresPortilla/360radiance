...
export function FloatingButtons() {
  return (
    <div className="fixed bottom-6 right-6 max-md:bottom-4 max-md:right-4 z-90 flex flex-col gap-3 items-end print:hidden" role="group" aria-label="Quick actions">
      <Link
        href="/contact"
      ...
      >
        <div className="absolute right-15.5 bg-white text-text py-2 px-4 rounded-xl text-[.75rem] font-semibold shadow-md whitespace-nowrap opacity-0 translate-x-2 transition-all duration-250 pointer-events-none group-hover:opacity-100 group-hover:translate-x-0" aria-hidden="true">
          Chat with us
        </div>
